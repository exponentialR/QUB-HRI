...
def get_video_bitrate(video_path):
    ...
    try:
        result = subprocess.check_output(['ffprobe', '-v', 'error', '-select_streams', 'v:0', '-show_entries', 'stream=bit_rate', '-of', 'default=noprint_wrappers=1:nokey=1', video_path])
...
def add_audio_var_video(video_path: str = None, output_video_path: str = None, long_audio_clip: AudioFileClip = None):
    ...
    final_video_clip.write_videofile(output_video_path, codec='libx264', audio_codec='aac', bitrate=original_bitrate, verbose=False)
